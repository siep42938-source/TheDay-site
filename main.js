...
// ============================================================
// Реальные модули TheDay Client (Rich-Modern)
const CLIENT_MODS = {
  visuals: [
    { name: 'Ambience',        on: true,  key: null },
    { name: 'Arrows',          on: false, key: null },
    { name: 'BlockESP',        on: false, key: 'B'  },
    { name: 'BlockOverlay',    on: true,  key: null },
    { name: 'CameraSettings',  on: false, key: null },
    { name: 'ChinaHat',        on: false, key: null },
    { name: 'ChunkAnimator',   on: true,  key: null },
    { name: 'ESP',             on: true,  key: 'E'  },
    { name: 'FullBright',      on: true,  key: 'F'  },
    { name: 'GlassHands',      on: false, key: null },
    { name: 'HitEffect',       on: true,  key: null },
    { name: 'ItemPhysic',      on: true,  key: null },
    { name: 'JumpCircle',      on: false, key: null },
    { name: 'NoRender',        on: false, key: null },
    { name: 'Particles',       on: true,  key: 'P'  },
    { name: 'SeeInvisible',    on: false, key: null },
    { name: 'SwingAnimation',  on: true,  key: null },
    { name: 'TargetESP',       on: true,  key: null },
    { name: 'ViewModel',       on: false, key: null },
    { name: 'WorldParticles',  on: false, key: null },
  ],
  hud: [
    { name: 'Watermark',   on: true,  key: null },
    { name: 'Arraylist',   on: true,  key: 'V'  },
    { name: 'Armor HUD',   on: true,  key: null },
    { name: 'CoolDowns',   on: true,  key: null },
    { name: 'HotKeys',     on: true,  key: null },
    { name: 'Info',        on: true,  key: null },
    { name: 'Inventory',   on: false, key: null },
    { name: 'Notifications', on: true, key: null },
    { name: 'Potions',     on: false, key: null },
    { name: 'Staff',       on: false, key: null },
    { name: 'TargetHUD',   on: true,  key: null },
  ],
  utilities: [
    { name: 'AimAssist',    on: false, key: null },
    { name: 'AntiBot',      on: true,  key: null },
    { name: 'Aura',         on: false, key: 'R'  },
    { name: 'AutoCrystal',  on: false, key: null },
    { name: 'AutoGApple',   on: false, key: null },
    { name: 'AutoSwap',     on: false, key: null },
    { name: 'AutoTotem',    on: true,  key: null },
    { name: 'AutoSprint',   on: true,  key: null },
    { name: 'BowSpammer',   on: false, key: null },
    { name: 'ChestStealer', on: false, key: null },
    { name: 'ElytraMotion', on: false, key: null },
    { name: 'Fly',          on: false, key: 'G'  },
    { name: 'FreeCam',      on: false, key: null },
    { name: 'HitSound',     on: true,  key: null },
    { name: 'InventoryMove', on: true, key: null },
    { name: 'Jesus',        on: false, key: null },
    { name: 'LongJump',     on: false, key: null },
    { name: 'MaceTarget',   on: false, key: null },
    { name: 'NoFallDamage', on: false, key: null },
    { name: 'NoSlow',       on: true,  key: null },
    { name: 'Speed',        on: false, key: 'X'  },
    { name: 'TriggerBot',   on: false, key: null },
    { name: 'Velocity',     on: false, key: null },
  ],
};
...
const HOTKEYS = {
  visuals:   [
    { name: 'ESP',        key: 'E' },
    { name: 'FullBright', key: 'F' },
    { name: 'Particles',  key: 'P' },
    { name: 'BlockESP',   key: 'B' },
  ],
  hud:       [
    { name: 'Arraylist',  key: 'V' },
    { name: 'Watermark',  key: 'W' },
    { name: 'TargetHUD',  key: 'T' },
    { name: 'CoolDowns',  key: 'C' },
  ],
  utilities: [
    { name: 'Aura',       key: 'R' },
    { name: 'Fly',        key: 'G' },
    { name: 'Speed',      key: 'X' },
    { name: 'AutoTotem',  key: 'A' },
  ],
};
